            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1">
                    <GlassPanel className="flex flex-col items-center text-center p-6 sm:p-6">
                        <div className="w-32 h-32 rounded-full bg-primary-100 dark:bg-primary-900/30 border-4 border-white dark:border-gray-700 shadow-xl flex items-center justify-center mb-4">
